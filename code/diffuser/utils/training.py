...
class Trainer(object):
    ...
    def save(self):
        ...
        if self.save_checkpoints:
            ...
            savepath = os.path.join(savepath, 'debug_1e5_1000_200.pt') #'state.pt') #'debug_1e4_1000_200.pt')
    ...
    def load(self):
        ...
        loadpath = os.path.join(self.bucket, 'checkpoint/debug_1e5_1000_200.pt') #'checkpoint/debug_1e4_100_200.pt')
