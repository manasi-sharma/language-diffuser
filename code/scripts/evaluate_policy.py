...
class CustomModel:
    def __init__(self, cfg):
        ...
        state_dict = torch.load(f'/iliad/u/manasis/language-diffuser/code/logs/checkpoint/new_langdiffuser_1e5_1000_200_bsize_32.pt',
...
def wrap_main(config_name):
    ...
    def main(cfg: DictConfig) -> None:
        ...
        args.train_folder = '/iliad/u/manasis/language-diffuser/code/outputs/2023-02-21/14-29-14/'
